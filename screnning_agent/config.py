...
open_ai_embedding_folder = os.path.join(mimic_iv_folder, 'open_ai_embedding')
open_ai_full_admission_embedding_folder = os.path.join(mimic_iv_folder, 'open_ai_full_admission_embedding')
