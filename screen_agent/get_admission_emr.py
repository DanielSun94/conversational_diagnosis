...
def main():
    reserved_icd_code_path = os.path.abspath('./resource/mimic_iv_disease_reserve.csv')
    diagnosis_path = os.path.abspath('./resource/mimic_iv/diagnoses_icd.csv')
    mimic4_file = os.path.abspath('resource/mimic_iv/discharge.csv')
    save_file = os.path.abspath('resource/mimic_iv/reserved_note.csv')
    filtered_file = os.path.abspath('resource/mimic_iv/filtered_note_id.csv')
