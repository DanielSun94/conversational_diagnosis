...
fixed_question_answer_folder = os.path.join(mimic_iv_folder, 'fixed_question_list')
fixed_question_answer_embedding_zh_path = os.path.join(mimic_iv_folder, 'fixed_question_zh_embedding.pkl')
fixed_question_answer_embedding_en_path = os.path.join(mimic_iv_folder, 'fixed_question_en_embedding.pkl')
...
unified_icd_path = os.path.join(mimic_iv_folder, 'unified_diagnosis_icd.csv')
disease_count_path_template = os.path.join(mimic_iv_folder, 'disease_count_{}_top_{}.csv')
unified_disease_count_path_template = os.path.join(mimic_iv_folder, 'unified_disease_count_{}_top_{}_{}.csv')
...
icd_9_mapping_file_path = os.path.join(resource_folder, 'icd_conversion', 'icd9toicd10cmgem.csv')
full_diagnosis_group_path = os.path.join(mimic_iv_folder, 'unified_disease_count_all_top_100_3_reserve_human_annotated.csv')
...
# 不包括主诉和现病史
open_ai_admission_embedding_folder = os.path.join(mimic_iv_folder, 'open_ai_admission_embedding')
question_embedding_folder = os.path.join(mimic_iv_folder, 'fixed_question_embedding')
